...
# Baker configuration
BAKER_INCLUDE_BEDROCK_MK ?= yes
BAKER_INCLUDE_BUILD_MK ?= yes
BAKER_INCLUDE_ITEST_MK ?= yes
BAKER_INCLUDE_UTEST_MK ?= yes
BAKER_INCLUDE_IBENCH_MK ?= yes
BAKER_INCLUDE_GEN_MK ?= yes
...
ifneq ($(APP_SECRETS_ROOT),)
	DOCKER_APP_SECRETS_OPTS ?= -v $(APP_SECRETS_ROOT):$(APP_SECRETS_ROOT_D) \
