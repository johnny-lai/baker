...
image-testdb:
	...
	$(DOCKER) tag $(TESTDB_DOCKER_LABEL_COMMIT) $(TESTDB_DOCKER_LABEL)
	$(DOCKER) tag $(TESTDB_DOCKER_LABEL_COMMIT) $(TESTDB_DOCKER_LABEL_VERSION)
...
image-dist: distbuild
	...
	$(DOCKER) tag $(APP_DOCKER_LABEL_COMMIT) $(APP_DOCKER_LABEL)
	$(DOCKER) tag $(APP_DOCKER_LABEL_COMMIT) $(APP_DOCKER_LABEL_VERSION)
